...
#     import cPickle as pickle # python 2 使用 cPickle
# else:
#     import pickle
...
class TextDataset(data.Dataset):
    ...
    # 为每个加载文件加载boungding_boxes 如 '001.Black_footed_Albatross/Black_Footed_Albatross_0046_18':[60, 27, 325, 304]
    def load_bbox(self):
        ...
        print('first file name example: ', filenames[0])
        #
